...
<%
a=request.getParameter("select11");
b=request.getParameter("textfield11");
b1=request.getParameter("select12");
if(b!=null)
{
...
{Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");}
	...
	rs=st.executeQuery("SELECT * from propertydetail where  city='"+a+"'and propertytype='" +b1+"'  and dealtype='SELL' ");
	res=false;
	total=0;
	while(rs.next())
	{
	ag1=rs.getDouble("sellprice"); 
	if(ag1<=ag)
	{
	total++;
	}
